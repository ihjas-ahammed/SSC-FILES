...
AI has transformed the way information is designed, organized, and delivered. For instance, tools such as Canva, Beautiful.ai, and Microsoft Designer assist in creating visually compelling slides.
...
What are the general and specific questions that my presentation addresses? What is(are) the hypothesis(es) of my presentation?
...
The grand finale: What do I conclude? What did we learn about the big scientific problem?
...
Try to talk directly to people in the audience, as you would if you were sitting down with just one person. 2.

Pictures tell a thousand words: Don’t make the audience read lots of text. Use as few words on your slides as possible.

You want the audience to listen to you, not read, or else you will lose them. Use cartoons, images, or short phrases instead of written sentences and then use your voice to tell us what you want us to know.
...
NEVER assume the audience knows more than you. You need to tell us the ideas, methods, and info; unless they are very common knowledge.

It helps to know your audience to judge this. Don’t use jargon unless you define it clearly or unless it’s really common.

5. Don’t make your audience read your mind, or figure out what your slides are about.
...
You need to state what you conclude from an observation, and importantly: state what your main points or ideas are (including background information), even when the point/idea seems obvious, and even though the audience may have their own ideas/interpretations. 6.
...
7. Good flow comes from smooth transitions between slides.
...
This takes practice. NOTE: Sometimes you just have to switch gears and tell a new different story.

When you do this, pause, and make it clear that’s what you’re doing. 8.

Less is more: Don’t cram too much data or info into a talk. You don’t have to show every last piece of data you ever got.

A good rule of thumb is about 1 slide/min or LESS. (Less if you have several complex slides that demand a lot of time).

Exceptions: several slides that really are replicates that build up to one slide....these count essentially as one slide (this is a good technique by the way). 9.
...
Do not give background that is not relevant to your presentation. NOTE: It can also be effective to reverse this: tell a story of prior findings and what they might mean, and then state a paradox, big problem, or grand hypothesis revealed by these findings.
...
And then tell your audience, in the form of a prediction of a hypothesis, a question or a problem you address in the experiment. In general, the best scenario is the following: 1.
...
Then, for each experiment slide, state specific predictions of that hypothesis(es) addressed by the experiment. 3.
...
Again, don’t assume the audience knows anything other than the most common techniques. And importantly, you need to tell the audience what’s being shown and what they should look at: directly point at the key image, gel band, line on a graph, or table entry.`
            },
            {
              ...
              content: `Alternatively, you can pose a question, then state how you addressed it. - Explain the experiment: Tell us what you did and what the panels/gels show. Again, don’t assume the audience knows anything other than the most common techniques.

And importantly, you need to tell the audience what’s being shown and what they should look at: directly point at the key image, gel band, line on a graph, or table entry. If you make people spend time trying to figure it out, your message will get lost. - For each result or set of closely related results: what does it mean?

Tell us what you conclude from EVERY result you present. The ONLY exception to this is if a set of closely related experiments together lead to the same conclusion: In this case, it may work best to wait and make your conclusion after presenting each of the related results. - Minimize the complexity of data slides: It’s better to split up graphs/images/gels into separate slides than to have too many on one slide.

Your slides should NEVER look like a multipanel figure in a paper. - Use photoshop or equivalent to crop unnecessary info and to reorganize into logical easy-to-follow patterns: e.g. for gels, you rarely have to show every lane. Same for cell images (e.g. immunofluorescence); often you only need the key result and the key control. - Alternatively, or in addition, talk ONLY about the key lane/image/number/panel.

You don’t have to talk about everything on your slide.`
            },
            {
              id: "sl-u15-mid3",
              type: "theory",
...
You don’t have to show every piece of data you ever generated. This is especially important for short talks (10-15 min).
...
A good way to do this is to propose models with cartoons that fit your data, or refer back to and alter a model that you started with. At a minimum, you should summarize BUT don’t use lots of sentences on your slides.

2. Tell us what important questions remain, and, even better, tell us what NEW questions arise from your results, if possible.

NOTE: In grad student talks, it is very common (and good for your committee) to tell us what you plan to do next. BUT: Don’t just throw up a laundry list of random experiments and controls you plan to do.
