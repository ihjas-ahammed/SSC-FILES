...
Base:
       ...
       Sections are set of 2-3 units in modules as in syllabus
        ...
        As for real anlysis, You have to focus on the definitions, use mathjax support, a lesson will be like this:
              ...
              - If it is a proof questions:
                     Slide 0: The question itself
                     Slide 1: The properties used in the solution
                     Slide 2: Intractive Solution
                     Slide 3: Objective question about solution 1
                     Slide 4: Objective question about soultion 2
