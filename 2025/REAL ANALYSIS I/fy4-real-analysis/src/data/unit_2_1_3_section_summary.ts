...
export const UNIT_2_1_3: Unit = {
  ...
  lessons: [
    {
      id: "les-2-1-3-sum1", title: "Summary: Field Axioms", description: "Recap of Unit 2.1.1", icon: "BookOpen",
      slides: [
        { id: "s0", type: "theory", title: "Recap: Field Axioms", content: "In this unit, we established the core algebraic properties of the real numbers:\n\n- **Field Axioms:** The fundamental rules for addition and multiplication (commutativity, associativity, identities, inverses, and distributivity).\n- **Uniqueness:** The elements $0$ and $1$ are unique, and inverses (like $-a$ and $1/a$) are unique.\n- **Zero Product:** Multiplying by zero always yields zero ($a \\cdot 0 = 0$). Also, if $ab = 0$, then $a = 0$ or $b = 0$.\n- **Irrationality:** The field of rational numbers $\\mathbb{Q}$ is incomplete. For example, there is no rational number $r$ satisfying $r^2 = 2$." },
