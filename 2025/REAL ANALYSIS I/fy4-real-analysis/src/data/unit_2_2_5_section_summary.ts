...
export const UNIT_2_2_5: Unit = {
  ...
  lessons: [
    ...
    {
      id: "les-2-2-5-sum2", title: "Summary: Neighborhoods", description: "Recap of Unit 222 & 224", icon: "BookOpen",
      slides: [
