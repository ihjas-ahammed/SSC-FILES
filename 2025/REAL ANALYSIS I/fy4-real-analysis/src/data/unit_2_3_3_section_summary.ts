...
export const UNIT_2_3_3: Unit = {
  ...
  lessons: [
    {
      id: "les-2-3-3-sum1", title: "Summary: Suprema & Infima", description: "Recap of Unit 2.3.1", icon: "BookOpen",
      slides: [
    ...
    {
      id: "les-2-3-3-sum2", title: "Summary: Completeness Axiom", description: "Recap of Unit 2.3.2", icon: "BookOpen",
      slides: [
