...
Improve the prompt losing anything I wrote but for the english syllabus
It is supposed to help the user understand and memorize everything about the topic with details from Thafheem

Like here, a module will be the modules in the index
a section will be a unit and a unit will be parts of section:

basically, introduction, text, questions
but the text part can be further divided to units
