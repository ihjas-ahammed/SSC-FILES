...
export const SECTION_4_5: Section = {
  id: "section-4-5",
  title: "Section 4.5: Thevenin's, Norton's & Max Power Theorems",
  description: "Simplifying complex networks to equivalent sources and understanding power transfer.",
  color: "duo-orange",
  units:[
    {
    ...
    },
    {
      ...
      lessons:[
        {
          id: "les-sum-theorems",
          title: "Network Theorems Recap",
          description: "Review of Thevenin, Norton, and Max Power.",
          icon: "CheckSquare",
          slides:[
