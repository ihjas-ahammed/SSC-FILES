...
Since the new syllabus is python, remove the unwanted elements and include a new slide to write and run code examples like in a notebook, you only have to craete a symilar propt, i will apply the functionality and code myslef
