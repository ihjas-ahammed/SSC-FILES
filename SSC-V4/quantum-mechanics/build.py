...
def main():
    ...
    if mock:
        ...
        html = html.replace('<title>Quantum Mechanics · Study System</title>',
                            '<title>Quantum Mechanics · TEST (mock data)</title>')
        html = html.replace('<b>Quantum Mechanics</b>',
                            '<b>Quantum Mechanics</b><span>test · mock</span>', 1)
