#!/usr/bin/env python3
"""
Generates data/questions.rae.js:
Comprehensive Level 3 written question bank for Real Analysis for Entrance (GATE / JAM / CUSAT).
Covers modules E1 through E7, 5 questions per module (35 questions total).
"""
...
questions = [
  # ═══════════════════════════════════════════════════════════════════════════
  # MODULE E1: GENERAL METRIC SPACES (c.e1.1 - c.e1.5)
  # ═══════════════════════════════════════════════════════════════════════════
  {
    "id": "q.rae.e1.01",
    "course": "rae",
    ...
    "tests": ["c.e1.1", "c.e1.2", "c.e1.3", "c.e1.4"],
  ...
  # ═══════════════════════════════════════════════════════════════════════════
  # MODULE E2: COMPLETENESS AND BAIRE CATEGORY (c.e2.1 - c.e2.4)
  # ═══════════════════════════════════════════════════════════════════════════
  {
    "id": "q.rae.e2.01",
    "course": "rae",
  ...
  # ═══════════════════════════════════════════════════════════════════════════
  # MODULE E3: COMPACTNESS AND CONNECTEDNESS (c.e3.1 - c.e3.5)
  # ═══════════════════════════════════════════════════════════════════════════
  {
    "id": "q.rae.e3.01",
    "course": "rae",
  ...
  # ═══════════════════════════════════════════════════════════════════════════
  # MODULE E4: EQUICONTINUITY AND ASCOLI–ARZELÀ (c.e4.1 - c.e4.3)
  # ═══════════════════════════════════════════════════════════════════════════
  {
    "id": "q.rae.e4.01",
    "course": "rae",
  ...
  # ═══════════════════════════════════════════════════════════════════════════
  # MODULE E5: INVERSE AND IMPLICIT FUNCTION THEOREMS (c.e5.1 - c.e5.3)
  # ═══════════════════════════════════════════════════════════════════════════
  {
    "id": "q.rae.e5.01",
    "course": "rae",
  ...
  # ═══════════════════════════════════════════════════════════════════════════
  # MODULE E6: LEBESGUE MEASURE ON ℝ (c.e6.1 - c.e6.5)
  # ═══════════════════════════════════════════════════════════════════════════
  {
    "id": "q.rae.e6.01",
    "course": "rae",
  ...
  # ═══════════════════════════════════════════════════════════════════════════
  # MODULE E7: LEBESGUE INTEGRATION & CONVERGENCE THEOREMS (c.e7.1 - c.e7.5)
  # ═══════════════════════════════════════════════════════════════════════════
  {
    "id": "q.rae.e7.01",
    "course": "rae",
...
# Write to data/questions.rae.js
out_file = "data/questions.rae.js"
with open(out_file, "w", encoding="utf-8") as f:
    f.write("/* ══════════════════════════════════════════════════════════════════════════\n")
    f.write("   Real Analysis for Entrance (GATE / JAM / CUSAT)\n")
    f.write("   Level 3 Written Questions: Modules E1 - E7 (35 questions total)\n")
    f.write("   ══════════════════════════════════════════════════════════════════════════ */\n\n")
