...
where $\\hat{H} = -\\frac{\\hbar^2}{2m}\\frac{d^2}{dx^2} + V(x)$ is the Hamiltonian operator and $E$ is the separation constant representing the total energy eigenvalue.`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Separation Ansatz', m: '3373189\\Psi(x,t) = \\psi(x)\\phi(t) \\implies \\frac{\\partial \\Psi}{\\partial t} = \\psi \\frac{d\\phi}{dt}, \\quad \\frac{\\partial^2 \\Psi}{\\partial x^2} = \\phi \\frac{d^2 \\psi}{dx^2}3373189', meaning: 'What this really means: Substitute into the TDSE: iħ ∂Ψ/∂t = -(ħ²/2m) ∂²Ψ/∂x² + V(x)Ψ.', label: 'Separation Ansatz', math: '\\Psi(x,t) = \\psi(x)\\phi(t) \\implies \\frac{\\partial \\Psi}{\\partial t} = \\psi \\frac{d\\phi}{dt}, \\quad \\frac{\\partial^2 \\Psi}{\\partial x^2} = \\phi \\frac{d^2 \\psi}{dx^2}', note: 'Substitute into the TDSE: iħ ∂Ψ/∂t = -(ħ²/2m) ∂²Ψ/∂x² + V(x)Ψ.' },
        { why: 'Divide by ψφ', m: '3373189i\\hbar \\psi(x) \\frac{d\\phi}{dt} = -\\frac{\\hbar^2}{2m} \\phi(t) \\frac{d^2 \\psi}{dx^2} + V(x)\\psi(x)\\phi(t) \\implies i\\hbar \\frac{1}{\\phi(t)} \\frac{d\\phi}{dt} = -\\frac{\\hbar^2}{2m} \\frac{1}{\\psi(x)} \\frac{d^2 \\psi}{dx^2} + V(x)3373189', meaning: 'What this really means: The left side is purely a function of t, while the right side is purely a function of x.', label: 'Divide by ψφ', math: 'i\\hbar \\psi(x) \\frac{d\\phi}{dt} = -\\frac{\\hbar^2}{2m} \\phi(t) \\frac{d^2 \\psi}{dx^2} + V(x)\\psi(x)\\phi(t) \\implies i\\hbar \\frac{1}{\\phi(t)} \\frac{d\\phi}{dt} = -\\frac{\\hbar^2}{2m} \\frac{1}{\\psi(x)} \\frac{d^2 \\psi}{dx^2} + V(x)', note: 'The left side is purely a function of t, while the right side is purely a function of x.' },
        { why: 'Equate to Constant E', m: '3373189i\\hbar \\frac{1}{\\phi} \\frac{d\\phi}{dt} = E \\quad \\text{and} \\quad -\\frac{\\hbar^2}{2m} \\frac{d^2 \\psi}{dx^2} + V(x)\\psi = E\\psi3373189', meaning: 'What this really means: Since x and t vary independently, both sides must equal the same separation constant E.', label: 'Equate to Constant E', math: 'i\\hbar \\frac{1}{\\phi} \\frac{d\\phi}{dt} = E \\quad \\text{and} \\quad -\\frac{\\hbar^2}{2m} \\frac{d^2 \\psi}{dx^2} + V(x)\\psi = E\\psi', note: 'Since x and t vary independently, both sides must equal the same separation constant E.' },
        { why: 'Integrate Time Equation', m: '3373189\\frac{d\\phi}{\\phi} = -\\frac{iE}{\\hbar} dt \\implies \\ln \\phi = -\\frac{iEt}{\\hbar} + C \\implies \\phi(t) = e^{-iEt/\\hbar}3373189', meaning: 'What this really means: The integration constant is absorbed into the normalization of ψ(x).', label: 'Integrate Time Equation', math: '\\frac{d\\phi}{\\phi} = -\\frac{iE}{\\hbar} dt \\implies \\ln \\phi = -\\frac{iEt}{\\hbar} + C \\implies \\phi(t) = e^{-iEt/\\hbar}', note: 'The integration constant is absorbed into the normalization of ψ(x).' },
        { why: 'Final Spatial Eigenvalue Form', m: '3373189\\hat{H}\\psi(x) = E\\psi(x), \\quad \\text{with } \\hat{H} = -\\frac{\\hbar^2}{2m}\\frac{d^2}{dx^2} + V(x)3373189', meaning: 'What this really means: The TISE is the eigenvalue equation for the energy observable (Hamiltonian).', label: 'Final Spatial Eigenvalue Form', math: '\\hat{H}\\psi(x) = E\\psi(x), \\quad \\text{with } \\hat{H} = -\\frac{\\hbar^2}{2m}\\frac{d^2}{dx^2} + V(x)', note: 'The TISE is the eigenvalue equation for the energy observable (Hamiltonian).' }
      ]
    },
    cards: [
...
$$\\frac{d}{dt} \\langle \\hat{Q} \\rangle = 0, \\quad \\langle \\hat{Q} \\rangle = \\int_{-\\infty}^\\infty \\psi^*(x) \\hat{Q} \\psi(x) dx$$`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Evaluate Modulus Squared', m: '3373189|\\Psi(x,t)|^2 = \\left(\\psi(x)e^{-iEt/\\hbar}\\right)^* \\left(\\psi(x)e^{-iEt/\\hbar}\\right) = \\psi^*(x)\\psi(x) e^{iEt/\\hbar} e^{-iEt/\\hbar} = |\\psi(x)|^23373189', meaning: 'What this really means: Phase factor product is e^0 = 1.', label: 'Evaluate Modulus Squared', math: '|\\Psi(x,t)|^2 = \\left(\\psi(x)e^{-iEt/\\hbar}\\right)^* \\left(\\psi(x)e^{-iEt/\\hbar}\\right) = \\psi^*(x)\\psi(x) e^{iEt/\\hbar} e^{-iEt/\\hbar} = |\\psi(x)|^2', note: 'Phase factor product is e^0 = 1.' },
        { why: 'Sandwich Operator Q', m: '3373189\\langle \\hat{Q} \\rangle = \\int \\Psi^* \\hat{Q} \\Psi dx = \\int \\left(\\psi^*(x)e^{iEt/\\hbar}\\right) \\hat{Q} \\left(\\psi(x)e^{-iEt/\\hbar}\\right) dx3373189', meaning: 'What this really means: Since Q does not depend on time, e^{-iEt/ħ} passes freely through Q.', label: 'Sandwich Operator Q', math: '\\langle \\hat{Q} \\rangle = \\int \\Psi^* \\hat{Q} \\Psi dx = \\int \\left(\\psi^*(x)e^{iEt/\\hbar}\\right) \\hat{Q} \\left(\\psi(x)e^{-iEt/\\hbar}\\right) dx', note: 'Since Q does not depend on time, e^{-iEt/ħ} passes freely through Q.' },
        { why: 'Phase Cancellation', m: '3373189\\langle \\hat{Q} \\rangle = e^{iEt/\\hbar} e^{-iEt/\\hbar} \\int \\psi^*(x) \\hat{Q} \\psi(x) dx = \\int \\psi^*(x) \\hat{Q} \\psi(x) dx3373189', meaning: 'What this really means: The integral has no time dependence whatsoever.', label: 'Phase Cancellation', math: '\\langle \\hat{Q} \\rangle = e^{iEt/\\hbar} e^{-iEt/\\hbar} \\int \\psi^*(x) \\hat{Q} \\psi(x) dx = \\int \\psi^*(x) \\hat{Q} \\psi(x) dx', note: 'The integral has no time dependence whatsoever.' },
        { why: 'Differentiate with Respect to Time', m: '3373189\\frac{d}{dt} \\langle \\hat{Q} \\rangle = 03373189', meaning: 'What this really means: Hence every observable expectation value is completely stationary.', label: 'Differentiate with Respect to Time', math: '\\frac{d}{dt} \\langle \\hat{Q} \\rangle = 0', note: 'Hence every observable expectation value is completely stationary.' }
      ]
    },
    cards: [
...
Every single measurement of the total energy on a system in state $\\psi_n$ yields the exact eigenvalue $E_n$ with 100% certainty (zero dispersion).`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Compute ⟨H⟩', m: '3373189\\langle \\hat{H} \\rangle = \\int \\psi^* \\hat{H} \\psi dx = \\int \\psi^* (E\\psi) dx = E \\int |\\psi|^2 dx = E3373189', meaning: 'What this really means: Using ψ normalized to unity.', label: 'Compute ⟨H⟩', math: '\\langle \\hat{H} \\rangle = \\int \\psi^* \\hat{H} \\psi dx = \\int \\psi^* (E\\psi) dx = E \\int |\\psi|^2 dx = E', note: 'Using ψ normalized to unity.' },
        { why: 'Compute ⟨H²⟩', m: '3373189\\hat{H}^2 \\psi = \\hat{H}(\\hat{H}\\psi) = \\hat{H}(E\\psi) = E(\\hat{H}\\psi) = E(E\\psi) = E^2 \\psi3373189', meaning: 'What this really means: Operating twice scales by E².', label: 'Compute ⟨H²⟩', math: '\\hat{H}^2 \\psi = \\hat{H}(\\hat{H}\\psi) = \\hat{H}(E\\psi) = E(\\hat{H}\\psi) = E(E\\psi) = E^2 \\psi', note: 'Operating twice scales by E².' },
        { why: 'Integral for ⟨H²⟩', m: '3373189\\langle \\hat{H}^2 \\rangle = \\int \\psi^* \\hat{H}^2 \\psi dx = E^2 \\int |\\psi|^2 dx = E^23373189', meaning: 'What this really means: The expectation value of H² is exactly E².', label: 'Integral for ⟨H²⟩', math: '\\langle \\hat{H}^2 \\rangle = \\int \\psi^* \\hat{H}^2 \\psi dx = E^2 \\int |\\psi|^2 dx = E^2', note: 'The expectation value of H² is exactly E².' },
        { why: 'Compute Variance σ_H²', m: '3373189\\sigma_H^2 = \\langle \\hat{H}^2 \\rangle - \\langle \\hat{H} \\rangle^2 = E^2 - E^2 = 03373189', meaning: 'What this really means: Zero variance confirms definite energy with no statistical spread.', label: 'Compute Variance σ_H²', math: '\\sigma_H^2 = \\langle \\hat{H}^2 \\rangle - \\langle \\hat{H} \\rangle^2 = E^2 - E^2 = 0', note: 'Zero variance confirms definite energy with no statistical spread.' }
      ]
    },
    cards: [
...
<b>Physical Interpretation:</b> $|c_n|^2$ is the probability that a measurement of total energy will yield the eigenvalue $E_n$. Total probability conservation requires $\\sum_{n=1}^\\infty |c_n|^2 = 1$, and $\\langle H \\rangle = \\sum_{n=1}^\\infty |c_n|^2 E_n$.`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Superposition Principle', m: '3373189i\\hbar \\frac{\\partial}{\\partial t} \\left(\\sum c_n \\psi_n e^{-iE_n t/\\hbar}\\right) = \\sum c_n E_n \\psi_n e^{-iE_n t/\\hbar} = \\hat{H} \\left(\\sum c_n \\psi_n e^{-iE_n t/\\hbar}\\right)3373189', meaning: 'What this really means: Linearity ensures the sum satisfies the TDSE term-by-term.', label: 'Superposition Principle', math: 'i\\hbar \\frac{\\partial}{\\partial t} \\left(\\sum c_n \\psi_n e^{-iE_n t/\\hbar}\\right) = \\sum c_n E_n \\psi_n e^{-iE_n t/\\hbar} = \\hat{H} \\left(\\sum c_n \\psi_n e^{-iE_n t/\\hbar}\\right)', note: 'Linearity ensures the sum satisfies the TDSE term-by-term.' },
        { why: 'Initial Condition at t = 0', m: '3373189\\Psi(x,0) = \\sum_{n=1}^\\infty c_n \\psi_n(x)3373189', meaning: 'What this really means: Setting t = 0 eliminates the exponential phase factors.', label: 'Initial Condition at t = 0', math: '\\Psi(x,0) = \\sum_{n=1}^\\infty c_n \\psi_n(x)', note: 'Setting t = 0 eliminates the exponential phase factors.' },
        { why: 'Fourier Trick for c_n', m: '3373189\\int \\psi_m^*(x) \\Psi(x,0) dx = \\sum_n c_n \\int \\psi_m^*(x) \\psi_n(x) dx = \\sum_n c_n \\delta_{mn} = c_m3373189', meaning: 'What this really means: Multiply by ψ_m*(x), integrate over space, and use orthonormality.', label: 'Fourier Trick for c_n', math: '\\int \\psi_m^*(x) \\Psi(x,0) dx = \\sum_n c_n \\int \\psi_m^*(x) \\psi_n(x) dx = \\sum_n c_n \\delta_{mn} = c_m', note: 'Multiply by ψ_m*(x), integrate over space, and use orthonormality.' },
        { why: 'Normalization Condition', m: '3373189\\int |\\Psi(x,t)|^2 dx = \\sum_m \\sum_n c_m^* c_n e^{i(E_m - E_n)t/\\hbar} \\int \\psi_m^* \\psi_n dx = \\sum_n |c_n|^2 = 13373189', meaning: 'What this really means: Total probability is conserved and time-independent.', label: 'Normalization Condition', math: '\\int |\\Psi(x,t)|^2 dx = \\sum_m \\sum_n c_m^* c_n e^{i(E_m - E_n)t/\\hbar} \\int \\psi_m^* \\psi_n dx = \\sum_n |c_n|^2 = 1', note: 'Total probability is conserved and time-independent.' }
      ]
    },
    cards: [
...
$$\\boxed{\\psi_n(x) = \\sqrt{\\frac{2}{a}} \\sin\\left(\\frac{n\\pi x}{a}\\right)}$$`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'General Solution', m: '3373189\\frac{d^2\\psi}{dx^2} = -k^2 \\psi \\quad \\left(k \\equiv \\frac{\\sqrt{2mE}}{\\hbar}\\right) \\implies \\psi(x) = A \\sin(kx) + B \\cos(kx)3373189', meaning: 'What this really means: Harmonic oscillator ODE inside the well where V = 0.', label: 'General Solution', math: '\\frac{d^2\\psi}{dx^2} = -k^2 \\psi \\quad \\left(k \\equiv \\frac{\\sqrt{2mE}}{\\hbar}\\right) \\implies \\psi(x) = A \\sin(kx) + B \\cos(kx)', note: 'Harmonic oscillator ODE inside the well where V = 0.' },
        { why: 'Apply Left Boundary ψ(0) = 0', m: '3373189\\psi(0) = A\\sin(0) + B\\cos(0) = B = 0 \\implies \\psi(x) = A \\sin(kx)3373189', meaning: 'What this really means: The cosine term vanishes identically.', label: 'Apply Left Boundary ψ(0) = 0', math: '\\psi(0) = A\\sin(0) + B\\cos(0) = B = 0 \\implies \\psi(x) = A \\sin(kx)', note: 'The cosine term vanishes identically.' },
        { why: 'Apply Right Boundary ψ(a) = 0', m: '3373189\\psi(a) = A \\sin(ka) = 0 \\implies ka = n\\pi \\quad (n = 1, 2, 3, \\dots)3373189', meaning: 'What this really means: For non-trivial solution A ≠ 0, sin(ka) must vanish.', label: 'Apply Right Boundary ψ(a) = 0', math: '\\psi(a) = A \\sin(ka) = 0 \\implies ka = n\\pi \\quad (n = 1, 2, 3, \\dots)', note: 'For non-trivial solution A ≠ 0, sin(ka) must vanish.' },
        { why: 'Energy Quantization', m: '3373189k_n = \\frac{n\\pi}{a} \\implies E_n = \\frac{\\hbar^2 k_n^2}{2m} = \\frac{n^2 \\pi^2 \\hbar^2}{2m a^2}3373189', meaning: 'What this really means: Energy eigenvalues depend on n².', label: 'Energy Quantization', math: 'k_n = \\frac{n\\pi}{a} \\implies E_n = \\frac{\\hbar^2 k_n^2}{2m} = \\frac{n^2 \\pi^2 \\hbar^2}{2m a^2}', note: 'Energy eigenvalues depend on n².' },
        { why: 'Normalization Constant A', m: '3373189\\int_0^a |A|^2 \\sin^2\\left(\\frac{n\\pi x}{a}\\right) dx = |A|^2 \\frac{a}{2} = 1 \\implies A = \\sqrt{\\frac{2}{a}}3373189', meaning: 'What this really means: Choose positive real phase for A.', label: 'Normalization Constant A', math: '\\int_0^a |A|^2 \\sin^2\\left(\\frac{n\\pi x}{a}\\right) dx = |A|^2 \\frac{a}{2} = 1 \\implies A = \\sqrt{\\frac{2}{a}}', note: 'Choose positive real phase for A.' }
      ]
    },
    cards: [
...
$$f(x) = \\sum_{n=1}^\\infty c_n \\psi_n(x), \\qquad c_n = \\int_0^a \\psi_n^*(x) f(x) dx$$`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Set Up Overlap Integral', m: '3373189I_{mn} = \\frac{2}{a} \\int_0^a \\sin\\left(\\frac{m\\pi x}{a}\\right) \\sin\\left(\\frac{n\\pi x}{a}\\right) dx3373189', meaning: 'What this really means: Both wavefunctions are purely real.', label: 'Set Up Overlap Integral', math: 'I_{mn} = \\frac{2}{a} \\int_0^a \\sin\\left(\\frac{m\\pi x}{a}\\right) \\sin\\left(\\frac{n\\pi x}{a}\\right) dx', note: 'Both wavefunctions are purely real.' },
        { why: 'Product-to-Sum Identity', m: '3373189\\sin(A)\\sin(B) = \\frac{1}{2}\\left[\\cos(A - B) - \\cos(A + B)\\right]3373189', meaning: 'What this really means: Transforms product into two simple harmonic terms.', label: 'Product-to-Sum Identity', math: '\\sin(A)\\sin(B) = \\frac{1}{2}\\left[\\cos(A - B) - \\cos(A + B)\\right]', note: 'Transforms product into two simple harmonic terms.' },
        { why: 'Substitute Angles', m: '3373189I_{mn} = \\frac{1}{a} \\int_0^a \\left[\\cos\\left(\\frac{(m-n)\\pi x}{a}\\right) - \\cos\\left(\\frac{(m+n)\\pi x}{a}\\right)\\right] dx3373189', meaning: 'What this really means: Integrate term by term.', label: 'Substitute Angles', math: 'I_{mn} = \\frac{1}{a} \\int_0^a \\left[\\cos\\left(\\frac{(m-n)\\pi x}{a}\\right) - \\cos\\left(\\frac{(m+n)\\pi x}{a}\\right)\\right] dx', note: 'Integrate term by term.' },
        { why: 'Case m ≠ n', m: '3373189I_{mn} = \\frac{1}{a} \\left[\\frac{\\sin\\left(\\frac{(m-n)\\pi x}{a}\\right)}{(m-n)\\pi/a} - \\frac{\\sin\\left(\\frac{(m+n)\\pi x}{a}\\right)}{(m+n)\\pi/a}\\right]_0^a = 03373189', meaning: 'What this really means: Sin of integer multiples of π vanishes at both limits.', label: 'Case m ≠ n', math: 'I_{mn} = \\frac{1}{a} \\left[\\frac{\\sin\\left(\\frac{(m-n)\\pi x}{a}\\right)}{(m-n)\\pi/a} - \\frac{\\sin\\left(\\frac{(m+n)\\pi x}{a}\\right)}{(m+n)\\pi/a}\\right]_0^a = 0', note: 'Sin of integer multiples of π vanishes at both limits.' },
        { why: 'Case m = n', m: '3373189I_{nn} = \\frac{1}{a} \\int_0^a [1 - \\cos(2n\\pi x / a)] dx = \\frac{1}{a}(a - 0) = 13373189', meaning: 'What this really means: The integral evaluates to exactly δ_mn.', label: 'Case m = n', math: 'I_{nn} = \\frac{1}{a} \\int_0^a [1 - \\cos(2n\\pi x / a)] dx = \\frac{1}{a}(a - 0) = 1', note: 'The integral evaluates to exactly δ_mn.' }
      ]
    },
    cards: [
...
By Parseval's theorem, $\\int_{-\\infty}^\\infty |\\Psi(x,t)|^2 dx = \\int_{-\\infty}^\\infty |\\phi(k)|^2 dk = 1$.`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Set t = 0', m: '3373189\\Psi(x,0) = \\frac{1}{\\sqrt{2\\pi}} \\int_{-\\infty}^\\infty \\phi(k) e^{ikx} dk3373189', meaning: 'What this really means: Standard spatial Fourier transform.', label: 'Set t = 0', math: '\\Psi(x,0) = \\frac{1}{\\sqrt{2\\pi}} \\int_{-\\infty}^\\infty \\phi(k) e^{ikx} dk', note: 'Standard spatial Fourier transform.' },
        { why: 'Fourier Inversion Theorem', m: '3373189\\phi(k) = \\frac{1}{\\sqrt{2\\pi}} \\int_{-\\infty}^\\infty \\Psi(x,0) e^{-ikx} dx3373189', meaning: 'What this really means: Inverse transform yields the spectral amplitude φ(k).', label: 'Fourier Inversion Theorem', math: '\\phi(k) = \\frac{1}{\\sqrt{2\\pi}} \\int_{-\\infty}^\\infty \\Psi(x,0) e^{-ikx} dx', note: 'Inverse transform yields the spectral amplitude φ(k).' },
        ...
        { why: 'Verify Parseval Equality', m: '3373189\\int |\\Psi(x,0)|^2 dx = \\int_{-\\infty}^\\infty |\\phi(k)|^2 dk = 13373189', meaning: 'What this really means: Probability in position space equals probability in momentum space.', label: 'Verify Parseval Equality', math: '\\int |\\Psi(x,0)|^2 dx = \\int_{-\\infty}^\\infty |\\phi(k)|^2 dk = 1', note: 'Probability in position space equals probability in momentum space.' }
      ]
    },
    cards: [
...
Hence, the physical quantum wave packet moves precisely at the classical particle speed: $v_g = 2 v_p = v_{\\text{classical}}$.`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Dispersion Relation', m: '3373189E = \\hbar \\omega = \\frac{p^2}{2m} = \\frac{\\hbar^2 k^2}{2m} \\implies \\omega(k) = \\frac{\\hbar k^2}{2m}3373189', meaning: 'What this really means: Energy-frequency relation for a free particle.', label: 'Dispersion Relation', math: 'E = \\hbar \\omega = \\frac{p^2}{2m} = \\frac{\\hbar^2 k^2}{2m} \\implies \\omega(k) = \\frac{\\hbar k^2}{2m}', note: 'Energy-frequency relation for a free particle.' },
        { why: 'Compute Phase Velocity', m: '3373189v_p = \\frac{\\omega}{k} = \\frac{\\hbar k}{2m} = \\frac{p}{2m} = \\frac{1}{2}v_{\\text{cl}}3373189', meaning: 'What this really means: Notice the factor of 1/2.', label: 'Compute Phase Velocity', math: 'v_p = \\frac{\\omega}{k} = \\frac{\\hbar k}{2m} = \\frac{p}{2m} = \\frac{1}{2}v_{\\text{cl}}', note: 'Notice the factor of 1/2.' },
        ...
        { why: 'Envelope Argument', m: '3373189kx - \\omega t = k_0 x - \\omega_0 t + (k - k_0)(x - v_g t)3373189', meaning: 'What this really means: Phase separates into carrier phase and envelope displacement.', label: 'Envelope Argument', math: 'kx - \\omega t = k_0 x - \\omega_0 t + (k - k_0)(x - v_g t)', note: 'Phase separates into carrier phase and envelope displacement.' },
        { why: 'Evaluate Group Velocity', m: '3373189v_g = \\left.\\frac{d\\omega}{dk}\\right|_{k_0} = \\frac{\\hbar k_0}{m} = \\frac{p_0}{m} = v_{\\text{cl}}3373189', meaning: 'What this really means: The packet envelope moves at the exact Newtonian particle speed.', label: 'Evaluate Group Velocity', math: 'v_g = \\left.\\frac{d\\omega}{dk}\\right|_{k_0} = \\frac{\\hbar k_0}{m} = \\frac{p_0}{m} = v_{\\text{cl}}', note: 'The packet envelope moves at the exact Newtonian particle speed.' }
      ]
    },
    cards: [
...
The rate of change of probability inside any region equals the net flux of probability flowing through its boundary.`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Time Derivative of Density', m: '3373189\\frac{\\partial \\rho}{\\partial t} = \\frac{\\partial}{\\partial t}(\\Psi^* \\Psi) = \\frac{\\partial \\Psi^*}{\\partial t}\\Psi + \\Psi^* \\frac{\\partial \\Psi}{\\partial t}3373189', meaning: 'What this really means: Product rule for differentiation.', label: 'Time Derivative of Density', math: '\\frac{\\partial \\rho}{\\partial t} = \\frac{\\partial}{\\partial t}(\\Psi^* \\Psi) = \\frac{\\partial \\Psi^*}{\\partial t}\\Psi + \\Psi^* \\frac{\\partial \\Psi}{\\partial t}', note: 'Product rule for differentiation.' },
        { why: 'Substitute from TDSE', m: '3373189\\frac{\\partial \\Psi}{\\partial t} = \\frac{1}{i\\hbar}\\left(-\\frac{\\hbar^2}{2m}\\frac{\\partial^2 \\Psi}{\\partial x^2} + V\\Psi\\right), \\quad \\frac{\\partial \\Psi^*}{\\partial t} = -\\frac{1}{i\\hbar}\\left(-\\frac{\\hbar^2}{2m}\\frac{\\partial^2 \\Psi^*}{\\partial x^2} + V\\Psi^*\\right)3373189', meaning: 'What this really means: Complex conjugate inverts the sign of i.', label: 'Substitute from TDSE', math: '\\frac{\\partial \\Psi}{\\partial t} = \\frac{1}{i\\hbar}\\left(-\\frac{\\hbar^2}{2m}\\frac{\\partial^2 \\Psi}{\\partial x^2} + V\\Psi\\right), \\quad \\frac{\\partial \\Psi^*}{\\partial t} = -\\frac{1}{i\\hbar}\\left(-\\frac{\\hbar^2}{2m}\\frac{\\partial^2 \\Psi^*}{\\partial x^2} + V\\Psi^*\\right)', note: 'Complex conjugate inverts the sign of i.' },
        { why: 'Combine and Cancel Potential V', m: '3373189\\frac{\\partial \\rho}{\\partial t} = \\frac{i\\hbar}{2m}\\left(\\Psi^* \\frac{\\partial^2 \\Psi}{\\partial x^2} - \\Psi \\frac{\\partial^2 \\Psi^*}{\\partial x^2}\\right) + \\frac{1}{i\\hbar}(V\\Psi^*\\Psi - V\\Psi^*\\Psi)3373189', meaning: 'What this really means: The potential energy terms cancel identically because V is real.', label: 'Combine and Cancel Potential V', math: '\\frac{\\partial \\rho}{\\partial t} = \\frac{i\\hbar}{2m}\\left(\\Psi^* \\frac{\\partial^2 \\Psi}{\\partial x^2} - \\Psi \\frac{\\partial^2 \\Psi^*}{\\partial x^2}\\right) + \\frac{1}{i\\hbar}(V\\Psi^*\\Psi - V\\Psi^*\\Psi)', note: 'The potential energy terms cancel identically because V is real.' },
        { why: 'Identify Total Spatial Derivative', m: '3373189\\Psi^* \\frac{\\partial^2 \\Psi}{\\partial x^2} - \\Psi \\frac{\\partial^2 \\Psi^*}{\\partial x^2} = \\frac{\\partial}{\\partial x}\\left(\\Psi^* \\frac{\\partial \\Psi}{\\partial x} - \\Psi \\frac{\\partial \\Psi^*}{\\partial x}\\right)3373189', meaning: 'What this really means: Verify by expanding with the product rule.', label: 'Identify Total Spatial Derivative', math: '\\Psi^* \\frac{\\partial^2 \\Psi}{\\partial x^2} - \\Psi \\frac{\\partial^2 \\Psi^*}{\\partial x^2} = \\frac{\\partial}{\\partial x}\\left(\\Psi^* \\frac{\\partial \\Psi}{\\partial x} - \\Psi \\frac{\\partial \\Psi^*}{\\partial x}\\right)', note: 'Verify by expanding with the product rule.' },
        { why: 'Resulting Continuity Form', m: '3373189\\frac{\\partial \\rho}{\\partial t} = -\\frac{\\partial}{\\partial x}\\left[\\frac{\\hbar}{2mi}\\left(\\Psi^* \\frac{\\partial \\Psi}{\\partial x} - \\Psi \\frac{\\partial \\Psi^*}{\\partial x}\\right)\\right] = -\\frac{\\partial J}{\\partial x}3373189', meaning: 'What this really means: Yields ∂ρ/∂t + ∂J/∂x = 0.', label: 'Resulting Continuity Form', math: '\\frac{\\partial \\rho}{\\partial t} = -\\frac{\\partial}{\\partial x}\\left[\\frac{\\hbar}{2mi}\\left(\\Psi^* \\frac{\\partial \\Psi}{\\partial x} - \\Psi \\frac{\\partial \\Psi^*}{\\partial x}\\right)\\right] = -\\frac{\\partial J}{\\partial x}', note: 'Yields ∂ρ/∂t + ∂J/∂x = 0.' }
      ]
    },
    cards: [
...
Stationary bound states carry zero net probability current everywhere in space.`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Insert Real Function', m: '3373189\\psi(x) \\in \\mathbb{R} \\implies \\psi^*(x) = \\psi(x), \\quad \\frac{\\partial \\psi^*}{\\partial x} = \\frac{\\partial \\psi}{\\partial x}3373189', meaning: 'What this really means: Complex conjugation leaves the function invariant.', label: 'Insert Real Function', math: '\\psi(x) \\in \\mathbb{R} \\implies \\psi^*(x) = \\psi(x), \\quad \\frac{\\partial \\psi^*}{\\partial x} = \\frac{\\partial \\psi}{\\partial x}', note: 'Complex conjugation leaves the function invariant.' },
        { why: 'Compute Current', m: '3373189J = \\frac{\\hbar}{2mi} \\left( \\psi \\frac{\\partial \\psi}{\\partial x} - \\psi \\frac{\\partial \\psi}{\\partial x} \\right) = \\frac{\\hbar}{2mi}(0) = 03373189', meaning: 'What this really means: Both terms are identical and subtract to zero.', label: 'Compute Current', math: 'J = \\frac{\\hbar}{2mi} \\left( \\psi \\frac{\\partial \\psi}{\\partial x} - \\psi \\frac{\\partial \\psi}{\\partial x} \\right) = \\frac{\\hbar}{2mi}(0) = 0', note: 'Both terms are identical and subtract to zero.' },
        { why: 'Evaluate for Plane Wave', m: '3373189\\psi = A e^{ikx} \\implies \\psi^* = A^* e^{-ikx}, \\quad \\frac{d\\psi}{dx} = ik A e^{ikx}3373189', meaning: 'What this really means: Standard exponential derivative.', label: 'Evaluate for Plane Wave', math: '\\psi = A e^{ikx} \\implies \\psi^* = A^* e^{-ikx}, \\quad \\frac{d\\psi}{dx} = ik A e^{ikx}', note: 'Standard exponential derivative.' },
        { why: 'Product for Plane Wave', m: '3373189J = \\frac{\\hbar}{m} \\text{Im}\\left( A^* e^{-ikx} \\cdot ik A e^{ikx} \\right) = \\frac{\\hbar}{m} \\text{Im}\\left( ik |A|^2 \\right) = \\frac{\\hbar k}{m} |A|^23373189', meaning: 'What this really means: Matches classical fluid flux ρv.', label: 'Product for Plane Wave', math: 'J = \\frac{\\hbar}{m} \\text{Im}\\left( A^* e^{-ikx} \\cdot ik A e^{ikx} \\right) = \\frac{\\hbar}{m} \\text{Im}\\left( ik |A|^2 \\right) = \\frac{\\hbar k}{m} |A|^2', note: 'Matches classical fluid flux ρv.' }
      ]
    },
    cards: [
...
$$\\boxed{\\frac{B}{A} = \\frac{k_1 - k_2}{k_1 + k_2}, \\qquad \\frac{C}{A} = \\frac{2k_1}{k_1 + k_2}}$$`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Continuity of ψ at x = 0', m: '3373189\\psi_I(0) = \\psi_{II}(0) \\implies A + B = C3373189', meaning: 'What this really means: Evaluated at x = 0.', label: 'Continuity of ψ at x = 0', math: '\\psi_I(0) = \\psi_{II}(0) \\implies A + B = C', note: 'Evaluated at x = 0.' },
        ...
        { why: 'Substitute C = A + B', m: '3373189k_1(A - B) = k_2(A + B) \\implies (k_1 - k_2)A = (k_1 + k_2)B3373189', meaning: 'What this really means: Group terms in A and B.', label: 'Substitute C = A + B', math: 'k_1(A - B) = k_2(A + B) \\implies (k_1 - k_2)A = (k_1 + k_2)B', note: 'Group terms in A and B.' },
        { why: 'Reflection Amplitude B/A', m: '3373189\\frac{B}{A} = \\frac{k_1 - k_2}{k_1 + k_2}3373189', meaning: 'What this really means: Analogous to Fresnel reflection coefficient in optics.', label: 'Reflection Amplitude B/A', math: '\\frac{B}{A} = \\frac{k_1 - k_2}{k_1 + k_2}', note: 'Analogous to Fresnel reflection coefficient in optics.' },
        { why: 'Transmission Amplitude C/A', m: '3373189C = A + B = A\\left(1 + \\frac{k_1 - k_2}{k_1 + k_2}\\right) \\implies \\frac{C}{A} = \\frac{2k_1}{k_1 + k_2}3373189', meaning: 'What this really means: Standard transmission amplitude.', label: 'Transmission Amplitude C/A', math: 'C = A + B = A\\left(1 + \\frac{k_1 - k_2}{k_1 + k_2}\\right) \\implies \\frac{C}{A} = \\frac{2k_1}{k_1 + k_2}', note: 'Standard transmission amplitude.' }
      ]
    },
    cards: [
...
$$\\boxed{R + T = 1}$$`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Currents for Each Component', m: '3373189J_{\\text{inc}} = \\frac{\\hbar k_1}{m}|A|^2, \\quad J_{\\text{refl}} = -\\frac{\\hbar k_1}{m}|B|^2, \\quad J_{\\text{trans}} = \\frac{\\hbar k_2}{m}|C|^23373189', meaning: 'What this really means: Signs indicate propagation direction.', label: 'Currents for Each Component', math: 'J_{\\text{inc}} = \\frac{\\hbar k_1}{m}|A|^2, \\quad J_{\\text{refl}} = -\\frac{\\hbar k_1}{m}|B|^2, \\quad J_{\\text{trans}} = \\frac{\\hbar k_2}{m}|C|^2', note: 'Signs indicate propagation direction.' },
        { why: 'Compute R', m: '3373189R = \\frac{|J_{\\text{refl}}|}{J_{\\text{inc}}} = \\frac{|B|^2}{|A|^2} = \\left(\\frac{k_1 - k_2}{k_1 + k_2}\\right)^23373189', meaning: 'What this really means: Squared modulus of reflection amplitude.', label: 'Compute R', math: 'R = \\frac{|J_{\\text{refl}}|}{J_{\\text{inc}}} = \\frac{|B|^2}{|A|^2} = \\left(\\frac{k_1 - k_2}{k_1 + k_2}\\right)^2', note: 'Squared modulus of reflection amplitude.' },
        { why: 'Compute T', m: '3373189T = \\frac{J_{\\text{trans}}}{J_{\\text{inc}}} = \\frac{k_2 |C|^2}{k_1 |A|^2} = \\frac{k_2}{k_1} \\frac{4k_1^2}{(k_1 + k_2)^2} = \\frac{4k_1 k_2}{(k_1 + k_2)^2}3373189', meaning: 'What this really means: Factor of k₁ cancels.', label: 'Compute T', math: 'T = \\frac{J_{\\text{trans}}}{J_{\\text{inc}}} = \\frac{k_2 |C|^2}{k_1 |A|^2} = \\frac{k_2}{k_1} \\frac{4k_1^2}{(k_1 + k_2)^2} = \\frac{4k_1 k_2}{(k_1 + k_2)^2}', note: 'Factor of k₁ cancels.' },
        { why: 'Sum R + T', m: '3373189R + T = \\frac{(k_1 - k_2)^2 + 4k_1 k_2}{(k_1 + k_2)^2} = \\frac{k_1^2 - 2k_1 k_2 + k_2^2 + 4k_1 k_2}{(k_1 + k_2)^2} = \\frac{(k_1 + k_2)^2}{(k_1 + k_2)^2} = 13373189', meaning: 'What this really means: Exact algebraic unity.', label: 'Sum R + T', math: 'R + T = \\frac{(k_1 - k_2)^2 + 4k_1 k_2}{(k_1 + k_2)^2} = \\frac{k_1^2 - 2k_1 k_2 + k_2^2 + 4k_1 k_2}{(k_1 + k_2)^2} = \\frac{(k_1 + k_2)^2}{(k_1 + k_2)^2} = 1', note: 'Exact algebraic unity.' }
      ]
    },
    cards: [
...
$$\\boxed{\\delta = \\frac{1}{\\kappa} = \\frac{\\hbar}{\\sqrt{2m(V_0 - E)}}}$$`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Modulus of Complex Ratio', m: '3373189|B/A|^2 = \\frac{(k_1 - i\\kappa)(k_1 + i\\kappa)}{(k_1 + i\\kappa)(k_1 - i\\kappa)} = \\frac{k_1^2 + \\kappa^2}{k_1^2 + \\kappa^2} = 13373189', meaning: 'What this really means: A complex number divided by its complex conjugate always has modulus 1.', label: 'Modulus of Complex Ratio', math: '|B/A|^2 = \\frac{(k_1 - i\\kappa)(k_1 + i\\kappa)}{(k_1 + i\\kappa)(k_1 - i\\kappa)} = \\frac{k_1^2 + \\kappa^2}{k_1^2 + \\kappa^2} = 1', note: 'A complex number divided by its complex conjugate always has modulus 1.' },
        { why: 'Compute Current in Region II', m: '3373189J_{II} = \\frac{\\hbar}{m} \\text{Im}\\left( \\psi_{II}^* \\frac{d\\psi_{II}}{dx} \\right) = \\frac{\\hbar}{m} \\text{Im}\\left( C^* e^{-\\kappa x} \\cdot (-\\kappa C e^{-\\kappa x}) \\right)3373189', meaning: 'What this really means: Derivative of exponential.', label: 'Compute Current in Region II', math: 'J_{II} = \\frac{\\hbar}{m} \\text{Im}\\left( \\psi_{II}^* \\frac{d\\psi_{II}}{dx} \\right) = \\frac{\\hbar}{m} \\text{Im}\\left( C^* e^{-\\kappa x} \\cdot (-\\kappa C e^{-\\kappa x}) \\right)', note: 'Derivative of exponential.' },
        { why: 'Current Vanishes', m: '3373189J_{II} = -\\frac{\\hbar\\kappa}{m} |C|^2 e^{-2\\kappa x} \\, \\text{Im}(1) = 03373189', meaning: 'What this really means: Since the argument is purely real, its imaginary part is identically zero.', label: 'Current Vanishes', math: 'J_{II} = -\\frac{\\hbar\\kappa}{m} |C|^2 e^{-2\\kappa x} \\, \\text{Im}(1) = 0', note: 'Since the argument is purely real, its imaginary part is identically zero.' },
        { why: 'Conclusion', m: '3373189T = \\frac{J_{II}}{J_{\\text{inc}}} = 0 \\implies R = 1 - T = 13373189', meaning: 'What this really means: Complete reflection with zero net transmitted flux.', label: 'Conclusion', math: 'T = \\frac{J_{II}}{J_{\\text{inc}}} = 0 \\implies R = 1 - T = 1', note: 'Complete reflection with zero net transmitted flux.' }
      ]
    },
    cards: [
...
where $\\kappa = \\frac{\\sqrt{2m(V_0 - E)}}{\\hbar}$. Transmission $T > 0$ represents the phenomenon of <b>quantum tunneling</b> (or barrier penetration).`,
    ...
    proof: {
      ...
      rungs: [
        ...
        { why: 'Eliminate B, C, D to Relate A and F', m: '3373189\\frac{A}{F} = e^{ik_1 a}\\left[\\cosh(\\kappa a) + \\frac{i}{2}\\left(\\frac{\\kappa}{k_1} - \\frac{k_1}{\\kappa}\\right)\\sinh(\\kappa a)\\right]3373189', meaning: 'What this really means: Matrix transfer method or algebraic elimination.', label: 'Eliminate B, C, D to Relate A and F', math: '\\frac{A}{F} = e^{ik_1 a}\\left[\\cosh(\\kappa a) + \\frac{i}{2}\\left(\\frac{\\kappa}{k_1} - \\frac{k_1}{\\kappa}\\right)\\sinh(\\kappa a)\\right]', note: 'Matrix transfer method or algebraic elimination.' },
        { why: 'Compute Modulus Squared |A/F|²', m: '3373189\\left|\\frac{A}{F}\\right|^2 = \\cosh^2(\\kappa a) + \\frac{1}{4}\\left(\\frac{\\kappa}{k_1} - \\frac{k_1}{\\kappa}\\right)^2 \\sinh^2(\\kappa a) = 1 + \\frac{(\\kappa^2 + k_1^2)^2}{4k_1^2 \\kappa^2}\\sinh^2(\\kappa a)3373189', meaning: 'What this really means: Using cosh²(z) = 1 + sinh²(z).', label: 'Compute Modulus Squared |A/F|²', math: '\\left|\\frac{A}{F}\\right|^2 = \\cosh^2(\\kappa a) + \\frac{1}{4}\\left(\\frac{\\kappa}{k_1} - \\frac{k_1}{\\kappa}\\right)^2 \\sinh^2(\\kappa a) = 1 + \\frac{(\\kappa^2 + k_1^2)^2}{4k_1^2 \\kappa^2}\\sinh^2(\\kappa a)', note: 'Using cosh²(z) = 1 + sinh²(z).' },
        { why: 'Substitute k₁² and κ²', m: '3373189k_1^2 + \\kappa^2 = \\frac{2m V_0}{\\hbar^2}, \\quad 4k_1^2 \\kappa^2 = 4\\left(\\frac{2m}{\\hbar^2}\\right)^2 E(V_0 - E) \\implies T = \\left|\\frac{F}{A}\\right|^2 = \\left[1 + \\frac{V_0^2 \\sinh^2(\\kappa a)}{4E(V_0 - E)}\\right]^{-1}3373189', meaning: 'What this really means: Yields the celebrated barrier tunneling formula.', label: 'Substitute k₁² and κ²', math: 'k_1^2 + \\kappa^2 = \\frac{2m V_0}{\\hbar^2}, \\quad 4k_1^2 \\kappa^2 = 4\\left(\\frac{2m}{\\hbar^2}\\right)^2 E(V_0 - E) \\implies T = \\left|\\frac{F}{A}\\right|^2 = \\left[1 + \\frac{V_0^2 \\sinh^2(\\kappa a)}{4E(V_0 - E)}\\right]^{-1}', note: 'Yields the celebrated barrier tunneling formula.' }
      ]
    },
    cards: [
...
the barrier becomes 100% transparent ($R = 0, T = 1$). This phenomenon is the quantum mechanical origin of the <b>Ramsauer–Townsend effect</b> (the anomalous transparency of noble gas atoms to low-energy electrons).`,
    ...
    proof: {
      ...
      rungs: [
        { why: 'Analytic Continuation from E < V₀', m: '3373189\\kappa = \\frac{\\sqrt{2m(V_0 - E)}}{\\hbar} = i \\frac{\\sqrt{2m(E - V_0)}}{\\hbar} = i k_23373189', meaning: 'What this really means: Transforms evanescent wave into propagating wave.', label: 'Analytic Continuation from E < V₀', math: '\\kappa = \\frac{\\sqrt{2m(V_0 - E)}}{\\hbar} = i \\frac{\\sqrt{2m(E - V_0)}}{\\hbar} = i k_2', note: 'Transforms evanescent wave into propagating wave.' },
        { why: 'Identity for Hyperbolic Sine', m: '3373189\\sinh(\\kappa a) = \\sinh(i k_2 a) = i \\sin(k_2 a) \\implies \\sinh^2(\\kappa a) = -\\sin^2(k_2 a)3373189', meaning: 'What this really means: Standard complex trigonometric relation.', label: 'Identity for Hyperbolic Sine', math: '\\sinh(\\kappa a) = \\sinh(i k_2 a) = i \\sin(k_2 a) \\implies \\sinh^2(\\kappa a) = -\\sin^2(k_2 a)', note: 'Standard complex trigonometric relation.' },
        { why: 'Substitute into T Formula', m: '3373189T = \\left[1 + \\frac{V_0^2(-\\sin^2(k_2 a))}{4E(-(E - V_0))}\\right]^{-1} = \\left[1 + \\frac{V_0^2 \\sin^2(k_2 a)}{4E(E - V_0)}\\right]^{-1}3373189', meaning: 'What this really means: Minuses cancel in numerator and denominator.', label: 'Substitute into T Formula', math: 'T = \\left[1 + \\frac{V_0^2(-\\sin^2(k_2 a))}{4E(-(E - V_0))}\\right]^{-1} = \\left[1 + \\frac{V_0^2 \\sin^2(k_2 a)}{4E(E - V_0)}\\right]^{-1}', note: 'Minuses cancel in numerator and denominator.' },
        { why: 'Condition for T = 1', m: '3373189\\sin^2(k_2 a) = 0 \\implies k_2 a = n\\pi \\quad (n = 1, 2, 3, \\dots)3373189', meaning: 'What this really means: Zero in the denominator leaves T = 1/(1 + 0) = 1.', label: 'Condition for T = 1', math: '\\sin^2(k_2 a) = 0 \\implies k_2 a = n\\pi \\quad (n = 1, 2, 3, \\dots)', note: 'Zero in the denominator leaves T = 1/(1 + 0) = 1.' },
        { why: 'Resonant Energies', m: '3373189E_n = V_0 + \\frac{n^2 \\pi^2 \\hbar^2}{2m a^2}3373189', meaning: 'What this really means: Discrete transmission peaks where reflection is completely extinguished.', label: 'Resonant Energies', math: 'E_n = V_0 + \\frac{n^2 \\pi^2 \\hbar^2}{2m a^2}', note: 'Discrete transmission peaks where reflection is completely extinguished.' }
      ]
    },
    cards: [
