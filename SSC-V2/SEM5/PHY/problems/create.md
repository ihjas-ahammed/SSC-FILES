...
a. All theory needed to answer the question (not mentioned in question)

b. solution

and write the parctice questions in a row withopuit answers

also expand solution in a way a plus two 9ncvert) studnet would understand
...
As for practice questions, since they have same theory as real ones, draw them all toghther (like three in 1 row)

if a question gets bigger for that you could span upto 3 rows per problem

MAKE SURE ONLY SPAN IF THE QUESTION IS BIG, FOCUS more into 3 questions per image
