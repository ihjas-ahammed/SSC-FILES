...
Make the following changes:
       ...
       * make the intarctive proof button clickable and so open that certain lesson
add button to got next section (in lesson path), next module in (module note)
also auto hide missing canvas art (in notes)
