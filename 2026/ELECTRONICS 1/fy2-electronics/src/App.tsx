    ...
    if (saved) {
      try {
        ...
        initialProgress = {
          ...
          xp: parsed.xp || 0,
          currentModuleId: parsed.currentModuleId || 'module-1-semi'
        };
      } catch(e) {
